...
sections of each exercise.  \ident{Valgrind} is a program that runs your programs,
...
\item[1] You do the usual \verb|make ex4| and that builds it. Make sure the \ident{cc} command
    you see is the same and has the \verb|-g| option or your \ident{Valgrind} output won't
    have line numbers.
...
\item[8] Then \ident{Valgrind} goes crazy and yells at you for:
    \begin{description}
        ...
        \item[20-24] Next error is yet another one on line ex4.c:11 in the main function. \ident{Valgrind}
...
\item Read up on \ident{Valgrind} on the internet.
