...
This exercise shows you that C stores it's strings simply as an array
...
an array of integers and an array of characters, but that \ident{printf} thinks
that the \ident{name} is just a string.  Again, this is because to the C
